...
public class ApiExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    protected ResponseEntity<ApiError> handleDuplicateTransaction(DuplicateTransactionException ex,
                                                                   HttpServletRequest request) {
        ApiError apiError = ApiError.builder()
                .timestamp(Instant.now())
    ...
    protected ResponseEntity<ApiError> handleNotFound(AccountNotFoundException ex,
                                                      HttpServletRequest request) {
        ApiError apiError = ApiError.builder()
                .timestamp(Instant.now())
